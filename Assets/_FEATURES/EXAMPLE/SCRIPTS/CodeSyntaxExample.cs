...
using UnityEngine.Accessibility; // This is an example of a namespace that is greyed out, because it is not used in this script. So should be removed.

namespace Amused.Example.Syntax
{

    public class CodeSyntaxExample : MonoBehaviour
    {
        ...
        private float _privateFloatNoSerialize;
